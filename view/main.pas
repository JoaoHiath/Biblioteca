...
procedure TBiblioteca.lblClientesClick(Sender: TObject);
begin
  TfrmListaClientes.AbrirListaClientes(self);
end;

procedure TBiblioteca.lblLivrosClick(Sender: TObject);
begin
   TfrmListaLivros.AbrirListaLivros(self);
end;

procedure TBiblioteca.lblPedidosClick(Sender: TObject);
begin
